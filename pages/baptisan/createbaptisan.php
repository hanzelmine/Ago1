...
if (isset($_POST['insertBaptisan'])) {
    ...
    $result = insertBaptisan($data);

    if ($result === true) {
        $total = count($_POST['tempat_baptis']);
        set_alert('success', 'Berhasil Ditambahkan', "Berhasil menambahkan $total data baptisan.");
    } elseif ($result === 'duplicate') {
        set_alert('error', 'Gagal Menambahkan', 'ID Jemaat atau No. Surat Baptis sudah digunakan.');
    } else {
